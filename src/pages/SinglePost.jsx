...
const SinglePost = () => {
    return (
        <div className='w-10/12 flex flex-col m-auto justify-center text-white'>
            <div className='w-full'>
                <p className='text-xl font-bold bg-blue-500 rounded-xl w-fit px-4 py-1 my-4'>Technology</p>
                <p className='text-2xl font-bold my-2'>The Impact of Technology on the Workplace: How Technology is Changing in now days using AI</p>
            ...
            <div>
            <img className='my-4 rounded w-full' src={img1} alt="" />
                ...
                <h1 className='text-justify my-2 mt-4 font-bold text-xl'>Research Your Destination</h1>
                ...
                <h1 className='text-justify my-2 mt-4 font-bold text-xl'>Plan Your Itinerary</h1>
                <p className='text-gray-400 text-justify my-2'>While it's essential to leave room for spontaneity and unexpected adventures, having a rough itinerary can help you make the most of your time and budget. Identify the must-see sights and experiences and prioritize them according to your interests and preferences. This will help you avoid overscheduling and ensure that you have time to relax and enjoy your journey.
