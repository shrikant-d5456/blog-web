    ...
    <div className="w-10/12 flex flex-col m-auto justify-center">
      <div className="w-full flex justify-center">
        ...
        <div className="absolute w-full top-[55%] left-[20%]">
          <p className="text-xl font-bold bg-blue-500 rounded-xl w-fit px-4 py-1 my-2">
            Technology
          </p>
          <p className="text-2xl font-bold w-6/12 my-2">
            The Impact of Technology on the Workplace: How Technology is
            Changing in now days using AI
          </p>
      ...
      <div className="w-full flex justify-center my-8">
        <button className="border border-gray-800 shadow shadow-blue-500 text-gray-600 w-fit rounded px-4 py-2">
          View More
        </button>
      </div>
    </div>
